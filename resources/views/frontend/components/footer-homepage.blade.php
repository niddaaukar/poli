<footer id="footer" class="footer">
  <div class="container footer-top" style="margin-left: 10%; /* Geser ke kanan */">
    <div class="row gy-4">
      <!-- Deskripsi Poli -->
      <div class="col-lg-4 col-md-6 footer-about" style="margin-bottom: 20px;"> 
      ...
      <!-- Link Cepat -->
      <div class="col-lg-2 col-md-8 footer-links" style="margin-bottom: 40px; padding-top: 10px;"> 
        <h4>Link Cepat</h4>
        <ul>
      ...
      <div class="col-lg-2 col-md-3 footer-links" style="margin-bottom: 20px; padding-top: 10px;"> 
        ...
        <ul>
          ...
          <li><a href="https://wa.me/6289619636519?text=Halo%2C%20saya%20ingin%20bertanya%20terkait%20layanan%20poliklinik%20 Universitas Dian Nuswantoro.%0A%0ANama%20%20%20%20%3A%20%5BIsi%20nama%20Anda%5D%0ANIM%20%20%20%20%20%20%3A%20%5BIsi%20NIM%20Anda%2C%20jika%20diperlukan%5D%0AKeperluan%20%3A%20%5BSebutkan%20keperluan%20Anda%5D%0A%0ATerima%20kasih."
   target="_blank">
   WhatsApp: 0896-1963-6519
</a>
</li>
      </ul>
      </div>
