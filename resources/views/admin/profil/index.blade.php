...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Managemen Akun /</span> Profil Admin</h4>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.profil.edit') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" required>{{ old('alamat', $admin->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
